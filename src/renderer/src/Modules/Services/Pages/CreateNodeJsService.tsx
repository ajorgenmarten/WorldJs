...
import { ArrowLeft, Plus, Upload, X, FolderOpen } from 'lucide-react'
...
export default function CreateNodejsService() {
  ...
  const handleSubmit = () => {
    ...
    // Aquí iría la lógica para crear el servicio Node.js
  }
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="pt-8 pb-8">
        <div className="max-w-4xl mx-auto px-8">
          ...
          <h1 className="text-2xl font-normal text-gray-700">Crear Servicio Node.js</h1>
          <p className="text-gray-600 text-sm mt-2">Configura tu nueva aplicación Node.js</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <div className="flex gap-2">
                <Input
                  id="folderPath"
                  placeholder="/ruta/a/tu/proyecto-nodejs"
              ...
              <p className="text-xs text-gray-500">
                Selecciona la carpeta que contiene tu aplicación Node.js
              </p>
            </div>
            ...
            {/* Start Command */}
            <div className="space-y-2">
              <Label htmlFor="startCommand" className="text-gray-700 font-medium">
                Comando de Inicio
              </Label>
              <Input
                id="startCommand"
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Input
                id="url"
                placeholder="https://github.com/usuario/mi-api-nodejs.git"
                value={formData.url}
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">
                  Configura las variables de entorno para tu aplicación Node.js
                </p>
              </div>
              <div className="flex gap-2">
                <Button
